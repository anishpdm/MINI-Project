    ...
    <div class="container-scroller">
        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo" href="#"> Online Verification  </a>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#qnpaper" aria-expanded="false" aria-controls="students">
                            <span class="menu-title">View Employer Details </span>
                            <i class="menu-arrow"></i>
                            <i class="mdi mdi-crosshairs-gps menu-icon"></i>
                        </a>
                        <div class="collapse" id="qnpaper">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="employer_approval.php"> Verify Employers </a></li>
