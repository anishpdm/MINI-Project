...
if (isset($_POST["but"])) {
    ...
    $sql = "SELECT `id`  FROM `company` WHERE `username`='$Username' and `password`='$Password' and `status`=1 ";
...
while($row=$result->fetch_assoc()){
    ...
    $_SESSION['Cid']=$id;
        ...
        echo "<script type='text/javascript'> window.location.href='companyprofile.php' </script>";
    } else {
                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left p-5">
                            ...
                            <h6 class="font-weight-light">
                                <center> <b> Company   Sign in </b> </center>
                            </h6>
                            <form class="pt-3" method="POST">
                                ...
                                <div class="mt-3">
                                    ...
                                    <a class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn" href="companyreg.php"> Company Registration   </a>
