        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="index.html" class="js-logo-clone">HERB </a>
              </div>
            </div>
              ...
              if(isset($_POST['search']))
{
  ...
  $conn = new mysqli($dbhost,$dbUser,$dbPass,$dbName);
    ...
    $sql = "SELECT `id`, `category_id`, `product_name`, `product_pic`, `product_description`, `disease_1`, `disease_2`, `disease_3`,price FROM `products` WHERE product_name like '%$item%' OR
disease_1 like '%$item%' or disease_2 like '%$item%' or disease_3 like '%$item%'
     ";
