...
<html lang="en">
  ...
  <div class="site-wrap">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="index.html" class="js-logo-clone"> HERBAL </a>
              </div>
            </div>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="../Login/">Log-out</a> <span class="mx-2 mb-0"></div>
        </div>
      </div>
    </div>
        ...
        <div class="row mb-5">
          <div class="col-md-9 order-2">
            ...
            <div class="row mb-5">
                ...
                if(!$_GET['catid'])
                               {
                                 $sql = "SELECT `id`, `category_id`, `product_name`, `product_pic`, `product_description`, `disease_1`, `disease_2`, `disease_3`,price FROM `products` ";

                               }
                               else{
                                 $cat=$_GET['catid'];

                                 $sql = "SELECT `id`, `category_id`, `product_name`, `product_pic`, `product_description`, `disease_1`, `disease_2`, `disease_3`,price FROM `products` WHERE category_id= $cat ";
                ...
                // if(!$_GET['cat'])
                // {
                //   $sql = "SELECT `id`, `category_id`, `product_name`, `product_pic1`, `description`, `price` FROM `products` ";
                //
                // }
                // else{
                //   $cat=$_GET['cat'];
                //
                //   $sql = "SELECT `id`, `category_id`, `product_name`, `product_pic1`, `description`, `price` FROM `products` WHERE category_id=$cat";
                //
                //
                // }
  ...
  $id=$row['id'];
                                        ...
                                        <div class=block-4 text-center border>
                                          <figure class=block-4-image>
                                              <a href=''><img src='http://localhost/miniprojects/Herb/admin_panel/$imag' style=width:400px;height:400px; alt=Image placeholder class=img-fluid></a>
                                          </figure>

                                          <div class='block-4-text p-4'>
                                            <h3><a href='shop-single.html'> $name  </a></h3>
                                            <p class='mb-0'> $description </p>
                                            <p class='mb-0'> $disease_1 | $disease_2 | $disease_3 </p>
