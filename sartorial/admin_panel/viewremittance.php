            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">View Remittance </h2>
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-right">Chellan number</th>
                                        ...
                                        <tbody>
                                                ...
                                                if($_SESSION['username']){
                                                    ...
                                                    //query
                                                    $query = "SELECT mem.name,`month`, `year`, `paid_day`, `amount`, `chellan` FROM `monthly_remittance` m JOIN members mem on mem.id=m.`memb_id`
                                                    ";
