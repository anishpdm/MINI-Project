            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Benifits </h2>
                                ...
                                <form method=POST>
                                    <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            <tr>
                                                <th>Name</th>
                                                <th class="text-right">Benifit Type</th>
                                        ...
                                        <tbody>
                                                ...
                                                if($_SESSION['username']){
                                                    ...
                                                    //query
                                                    $query = "SELECT b.`id`, `memb_id`,m.name, `benefit_type`, `amount`, b.`applied_date`, b.`approved_date` FROM `benefits_apply` b JOIN members m on m.id=b.`memb_id` WHERE b.`status`=0
                                                    ";
                                                    ...
                                                    if($response){
                                                        while($result = $response->fetch_assoc()){
                                                            echo"<tr>
                                                                    ...
                                                                    <td><button class='btn btn-success' name='approvebtn' value=$result[id]>Approve</button></td>
...
if(isset($_POST['approvebtn']) ){
    ...
    $dbhost = "localhost";
           ...
           //creating mysql connection
           $conn = new mysqli($dbhost,$dbUser,$dbPass,$dbName);
$sql="UPDATE `benefits_apply` SET  `status`=1,approved_date=now() WHERE `id`=$Id ";
...
if($result===TRUE){
   ...
   echo "<script> window.location.href='approvetrans.php' </script>"; 
