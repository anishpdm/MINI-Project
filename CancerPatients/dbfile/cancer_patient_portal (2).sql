...
(2, 'Rakesh', 'sdfghj', 'type 3', 123457890, 678987, 'Rakesh', 'Haripdad', 3, 'Rakesh', 'Qwerty1234', 0),
(3, 'userTwo', 'sdfghjk', 'qwert', 1234567890, 12345, 'qwerty', 'sdfghjk', 1, 'userTwo', 'userTwo1234', 1);
...
INSERT INTO `requests` (`id`, `patient_id`, `message`, `reply`, `cancel_status`, `approve_status`) VALUES
(1, 1, 'dvbhdvbkdv', '', '', '');
