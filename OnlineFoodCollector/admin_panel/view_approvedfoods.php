...
$status=$result['acknowledgement'];
        ...
        <td>".$result['type']."</td>
                ...
                if($status==1)
                {
                    echo "<td>  <p class='badge badge-success'> Approved </p> </td> ";
                }
                else if($status==0){

                    echo "<td>  <p class='badge badge-warning'> In Process </p> </td> ";

                }
                else{
                    echo "<td>  <p class='badge badge-danger'> Rejected </p> </td> ";
