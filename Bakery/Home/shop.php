            ...
            <div class="row mb-5">
                ...
                <div class=block-4 text-center border>
                  <figure class=block-4-image>
                      <a href=shop-single.html><img style=width:400px;height:400px; alt=Image placeholder class=img-fluid></a>
                  </figure>
                </div>
            ...
            <div class="border p-4 rounded mb-4">
              ...
              <ul class="list-unstyled mb-0">
                ...
                //database properties
                  ...
                  if($response){
                      while($result = $response->fetch_assoc()){
                      echo"<li><a href=# class=d-flex>".$result['category_name']."</a></li>";
                      }
                      echo "</ul>";
                  }
                ?>
