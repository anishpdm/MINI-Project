                        ...
                        <div class="login-form">
                            <form action="" method="post">
                              ...
                              <?php
                                ...
                                $sql = "SELECT u.name,p.product_name,`user_id`, `product_id`, `quantity`, `amount`, `date` FROM `user_order` o JOIN products p on p.id=o.`product_id` JOIN users u on u.id=o.`user_id` ORDER BY u.id DESC";
