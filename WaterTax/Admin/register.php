                        ...
                        <div class="login-form">
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" placeholder="Email">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                        <label>Place</label>
                                        <input class="au-input au-input--full" type="text" name="place" placeholder="Place">
                                </div>
