                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input name="year" type="text" id="input-username" class="form-control form-control-alternative" placeholder="Enter the Program Name" >
                      </div>
                    </div>
...
<option value="Bsc Comp Science">Bsc Comp Science</option>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">    houseno </label>
                        <input type="text" id="input-email" class="form-control form-control-alternative" placeholder="Enter houseno" name="houseno" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-first-name">streetno  </label>

                        <input type="text" id="input-email" class="form-control form-control-alternative" placeholder="Enter streetno" name="streetno">
...
if(isset($_POST['but'])){
    ...
    $password=$_POST['password'];
     ...
     $sql = "INSERT INTO `students`(AcademicYear, `name`, `admno`, `department`,
      `houseno`, `streetno`, `pincode`, `mobileno`, `username`, `password`) VALUES 
      ('$year','$studentname','$admno','$dept','$address','$pincode','$mob','$username','$password')
      ";
