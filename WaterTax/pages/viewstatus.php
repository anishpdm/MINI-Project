    ...
    <div class="container-fluid mt--7">
        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
              <form method="POST">
                <h6 class="heading-small text-muted mb-4"> Bills   </h6>
                <div class="pl-lg-4">
...
<?php
 ...
 $sql = "SELECT `month`, `year`, `amount`, `paid_status` FROM `bills` WHERE `consumer_no`=$consumer_no
 ";
 ...
 if($result->num_rows>0)
 {
    ...
    <th>  MONTH </th>
    <th> YEAR </th>   <th> AMOUNT  </th> </tr>  ";

    while($row=$result->fetch_assoc())
    {
        $applicationtype=$row['month'];
